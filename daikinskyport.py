''' Daikin Skyport API request class taken entirely from apetrycki/daikinskyport. Not using any of the set functions, but left them in for completeness. All credit to the contributers to that project.'''
