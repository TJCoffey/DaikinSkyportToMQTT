...
I don't have this configured, so I haven't investigated
```
adrAction
adrActualStart
adrActualStop
...
```
# Outdoor Air Quality
The values here are what shows up on the One+ Air Quality screen, but change very slowly. I suspect the thermostat gets them (and outdoor air temp) from a web service, not a sensor
```
aqOutdoorAvailable
aqOutdoorLevel
aqOutdoorOzone
